  ...
  const handleConfirmReset = async () => {
    ...
    try {
      ...
      if (success) {
        ...
        // Force a brief reload state so UI fully remounts cleared subtask views.
        setIsLoadingTicketState(true);
        setResetRefreshKey(prev => prev + 1);
        setTimeout(() => setIsLoadingTicketState(false), 250);
          ...
          <div className="flex min-h-screen bg-gradient-to-br from-gray-50 via-gray-100 to-gray-50 overflow-hidden">
            ...
            <div className="flex-1 flex flex-col overflow-hidden">
              ...
              {!isLoadingTicketState && showEmptyState ? (
                ...
                <div key={resetRefreshKey} className="relative overflow-hidden">
