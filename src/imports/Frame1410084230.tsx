import svgPaths from "./svg-2mqco9iqqf";
...
function TableHeaderDefault() {
  return (
    <div className="bg-[#f3f9fc] content-stretch flex gap-[4.001px] h-[70.017px] items-center pb-[13.003px] pt-[12.003px] px-[12.003px] relative shrink-0 w-[49.012px]" data-name="table-header/default">
      ...
      <p className="flex-[1_0_0] font-['Roboto:Medium',sans-serif] font-medium leading-[16.004px] min-h-px min-w-px relative text-[12.003px] text-[rgba(0,0,0,0.85)] whitespace-pre-wrap" style={{ fontVariationSettings: "'wdth' 100" }}>
        &nbsp;
      </p>
    </div>
  );
...
function Frame1() {
  return (
    <div className="content-stretch flex gap-[3px] items-start relative shrink-0">
      <Filter />
      <div className="flex flex-col font-['Roboto:Medium',sans-serif] font-medium justify-center leading-[0] relative shrink-0 text-[0px] text-[rgba(0,0,0,0.85)] whitespace-nowrap" style={{ fontVariationSettings: "'wdth' 100" }}>
        <p className="font-['Roboto:Bold',sans-serif] font-bold leading-[16px] text-[12px]" style={{ fontVariationSettings: "'wdth' 100" }}>
          Tenant
        </p>
      </div>
    </div>
...
function ComponentsTableCellText45() {
  return (
    <div className="h-[48px] relative shrink-0 w-full" data-name="Components/Table-Cell/Text">
      <div className="flex flex-col justify-center overflow-clip rounded-[inherit] size-full">
        <div className="content-stretch flex flex-col items-start justify-center pb-[18px] pt-[17px] px-[12px] relative size-full">
          <p className="font-['Roboto:Bold',sans-serif] font-bold leading-[22px] relative shrink-0 text-[#1677ff] text-[14px]" style={{ fontVariationSettings: "'wdth' 100" }}>
            View Input
          </p>
        </div>
      </div>
