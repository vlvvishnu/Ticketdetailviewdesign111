import svgPaths from "./svg-jq41c7o5dd";
...
function Frame3() {
  return (
    <div className="absolute content-stretch flex gap-[9px] items-center left-[-432.2px] top-[-1.05px]">
      <p className="font-['Inter:Medium',sans-serif] font-medium leading-[18px] not-italic relative shrink-0 text-[#464240] text-[12px] w-[326px] whitespace-pre-wrap">{`Add Relevant record based on Workflow & tenant  from other subtasks / From affected Transaction`}</p>
      <Container3 />
      <Container4 />
      <Container5 />
    </div>
...
function Container1() {
  return (
    <div className="h-[37px] relative shrink-0 w-[1116px]" data-name="Container">
      <div className="bg-clip-padding border-0 border-[transparent] border-solid content-stretch flex flex-col items-start relative size-full">
        <Paragraph />
      </div>
    </div>
...
export default function ContextBanner() {
  return (
    <div className="bg-[#fbf2e6] content-stretch flex gap-[10px] items-center px-[12.111px] py-[13.111px] relative rounded-[12px] size-full" data-name="ContextBanner">
