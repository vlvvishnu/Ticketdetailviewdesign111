import svgPaths from "./svg-u83980pnkx";
...
function Frame() {
  return (
    <div className="absolute bg-[#354eb4] content-stretch flex gap-[8px] items-center justify-center left-[1135px] px-[16px] py-[8px] rounded-[4px] top-[12px] w-[143px]">
...
function Button() {
  return (
    <div className="absolute bg-white content-stretch flex gap-[8px] h-[34px] items-center justify-center left-[1004px] px-[43px] py-[16px] rounded-[6px] top-[13px]" data-name="Button">
      <div aria-hidden="true" className="absolute border border-[#d9d9d9] border-solid inset-0 pointer-events-none rounded-[6px]" />
...
function Group3() {
  return (
    <div className="absolute contents left-[1004px] top-[12px]">
      <Frame />
      <Button />
    </div>
  );
...
function Frame7() {
  return (
    <div className="absolute content-stretch flex flex-col gap-[12px] h-[154px] items-start left-[35px] top-[90px] w-[1278px]">
      <Frame1 />
      <Frame5 />
    </div>
  );
