import svgPaths from "./svg-svbpg8x7pk";

function Frame3() {
  return (
    <div className="absolute h-[593px] left-0 top-0 w-[1313px]">
...
function Frame2() {
  return (
    <div className="absolute h-[208px] left-[35px] top-[90px] w-[1313px]">
      <Frame3 />
    </div>
  );
}
...
function Input() {
  return (
    <div className="bg-white col-1 content-stretch flex gap-[8px] h-[32px] items-center justify-center ml-0 mt-[32px] px-[12px] py-[10px] relative rounded-[6px] row-1 w-[455px]" data-name="Input">
      ...
      <p className="css-4hzbpn flex-[1_0_0] font-['Roboto:Regular',sans-serif] font-normal leading-[22px] min-h-px min-w-px relative text-[14px] text-[rgba(0,0,0,0.25)]" style={{ fontVariationSettings: "'wdth' 100" }}>{`Select    `}</p>
      <IconRight />
    </div>
  );
}
...
function Frame() {
  return (
    <div className="absolute bg-[#354eb4] content-stretch flex gap-[8px] items-center justify-center left-[1135px] px-[16px] py-[8px] rounded-[4px] top-px w-[143px]">
...
function Button() {
  return (
    <div className="absolute bg-white content-stretch flex gap-[8px] h-[34px] items-center justify-center left-[1004px] px-[43px] py-[16px] rounded-[6px] top-[2px]" data-name="Button">
      <div aria-hidden="true" className="absolute border border-[#d9d9d9] border-solid inset-0 pointer-events-none rounded-[6px]" />
...
function Group3() {
  return (
    <div className="absolute contents left-[1004px] top-px">
      <Frame />
      <Button />
    </div>
  );
...
function EnableTrigger() {
  return (
    <div className="absolute content-stretch flex flex-col gap-[12px] h-[359px] items-start left-[35px] top-[90px] w-[1278px]" data-name="Enable/trigger">
      <Frame1 />
      <Frame5 />
    </div>
  );
...
export default function Frame7() {
  return (
    <div className="bg-white overflow-clip relative rounded-[4.105px] shadow-[0px_1.026px_11.288px_0px_rgba(0,0,0,0.44)] size-full">
      <p className="absolute css-ew64yg font-['Roboto:Medium',sans-serif] font-medium inset-[3.54%_68.06%_93.78%_2.46%] leading-[22.576px] text-[16px] text-black" style={{ fontVariationSettings: "'wdth' 100" }}>
        Choose Workflow and Tenant to Enable/Disable Workflow
      </p>
