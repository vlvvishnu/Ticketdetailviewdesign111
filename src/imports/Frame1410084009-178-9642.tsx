import svgPaths from "./svg-y2h6jl8rmh";
...
function PlayCircle() {
  return (
    <div className="relative shrink-0 size-[16px]" data-name="play-circle">
      <svg className="block size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 16 16">
        <g id="play-circle">
          <path d={svgPaths.p37b34800} fill="var(--fill-0, white)" id="Vector" />
        </g>
      </svg>
    </div>
  );
...
function Frame56() {
  return (
    <div className="bg-[#354eb4] content-stretch flex gap-[8px] items-center justify-center opacity-20 px-[16px] py-[8px] relative rounded-[4px] shrink-0 w-[141px]">
      <PlayCircle />
...
function Frame63() {
  return (
    <div className="content-stretch flex gap-[8px] items-center justify-center relative shrink-0">
      <Frame56 />
      <Frame57 />
      <div className="flex h-[34px] items-center justify-center relative shrink-0 w-0" style={{ "--transform-inner-width": "1185", "--transform-inner-height": "154" } as React.CSSProperties}>
...
function Frame64() {
  return (
    <div className="col-1 content-stretch flex gap-[16px] items-start ml-[1046px] mt-0 relative row-1">
      <Frame63 />
    </div>
  );
}
...
function Frame21() {
  return (
    <div className="bg-[#f0f5fd] h-[44px] relative shrink-0 w-full">
      ...
      <div className="flex flex-row items-center size-full">
        <div className="content-stretch flex items-center px-[16px] py-[8px] relative size-full">
          <div className="flex flex-col font-['Roboto:Regular',sans-serif] font-normal justify-center leading-[0] relative shrink-0 text-[#263238] text-[14px] whitespace-nowrap" style={{ fontVariationSettings: "'wdth' 100" }}>
            <p className="leading-[22px]">Brightstar Care</p>
          </div>
        </div>
      </div>
    </div>
      ...
      <div className="flex flex-row items-center size-full">
        <div className="content-stretch flex items-center px-[16px] py-[8px] relative size-full">
          <div className="flex flex-col font-['Roboto:Regular',sans-serif] font-normal justify-center leading-[0] relative shrink-0 text-[14px] text-[rgba(0,0,0,0.85)] whitespace-nowrap" style={{ fontVariationSettings: "'wdth' 100" }}>
            <p className="leading-[22px]">Alpine Care Home Health</p>
          </div>
        </div>
      </div>
    </div>
  ...
  return (
    <div className="bg-white h-[44px] relative shrink-0 w-full">
      ...
      <div className="flex flex-row items-center size-full">
        <div className="content-stretch flex items-center px-[16px] py-[8px] relative size-full">
          <div className="flex flex-col font-['Roboto:Regular',sans-serif] font-normal justify-center leading-[0] relative shrink-0 text-[14px] text-[rgba(0,0,0,0.85)] whitespace-nowrap" style={{ fontVariationSettings: "'wdth' 100" }}>
            <p className="leading-[22px]">Buckeye Home Health Care</p>
          </div>
        </div>
      </div>
    </div>
...
function Frame60() {
  return (
    <div className="content-stretch flex flex-col h-[160px] items-start relative shrink-0 w-[215px]">
      <Frame5 />
      <Frame9 />
      <Frame10 />
      <Frame11 />
...
function Frame15() {
  return (
    <div className="bg-[#f0f5fd] h-[44px] relative shrink-0 w-full">
      ...
      <div className="flex flex-row items-center size-full">
        <div className="content-stretch flex items-center px-[16px] py-[8px] relative size-full">
          <div className="flex flex-col font-['Roboto:Regular',sans-serif] font-normal justify-center leading-[0] relative shrink-0 text-[#263238] text-[13px] w-[234px]" style={{ fontVariationSettings: "'wdth' 100" }}>
            <p className="leading-[16px] whitespace-pre-wrap">Review Choice Demonstration</p>
          </div>
        </div>
      </div>
    </div>
...
function Frame59() {
  return (
    <div className="content-stretch flex flex-col h-[160px] items-start relative shrink-0 w-[217px]">
      <Frame12 />
      <Frame15 />
      <Frame16 />
      <Frame17 />
  ...
  return (
    <div className="bg-[#f0f5fd] h-[44px] relative shrink-0 w-full">
      ...
      <div className="flex flex-row items-center size-full">
        <div className="content-stretch flex items-center px-[16px] py-[8px] relative size-full">
          <div className="flex flex-col font-['Roboto:Regular',sans-serif] font-normal justify-center leading-[0] relative shrink-0 text-[#263238] text-[13px] whitespace-nowrap" style={{ fontVariationSettings: "'wdth' 100" }}>
            <p className="leading-[16px]">Configuration001</p>
          </div>
        </div>
      </div>
    </div>
  ...
  return (
    <div className="bg-white h-[44px] relative shrink-0 w-full">
      ...
      <div className="flex flex-row items-center size-full">
        <div className="content-stretch flex items-center px-[16px] py-[8px] relative size-full">
          <div className="flex flex-col font-['Roboto:Regular',sans-serif] font-normal justify-center leading-[0] relative shrink-0 text-[#263238] text-[13px] whitespace-nowrap" style={{ fontVariationSettings: "'wdth' 100" }}>
            <p className="leading-[16px]">Configuration002</p>
          </div>
        </div>
      </div>
    </div>
  ...
  return (
    <div className="bg-white h-[44px] relative shrink-0 w-full">
      ...
      <div className="flex flex-row items-center size-full">
        <div className="content-stretch flex items-center px-[16px] py-[8px] relative size-full">
          <div className="flex flex-col font-['Roboto:Regular',sans-serif] font-normal justify-center leading-[0] relative shrink-0 text-[#263238] text-[13px] whitespace-nowrap" style={{ fontVariationSettings: "'wdth' 100" }}>
            <p className="leading-[16px]">Configuration003</p>
          </div>
        </div>
      </div>
    </div>
    ...
    <div className="bg-[#f0f5fd] h-[44px] relative shrink-0 w-full">
      ...
      <div className="flex flex-row items-center size-full">
        <div className="content-stretch flex gap-[4px] items-center px-[16px] py-[8px] relative size-full">
          ...
          <div className="flex flex-col font-['Roboto:Regular',sans-serif] font-normal justify-center leading-[0] relative shrink-0 text-[#263238] text-[13px] whitespace-nowrap" style={{ fontVariationSettings: "'wdth' 100" }}>
            <p className="leading-[16px]">Run Invoked</p>
          </div>
        </div>
      </div>
    </div>
    ...
    <div className="bg-white h-[44px] relative shrink-0 w-full">
      ...
      <div className="flex flex-row items-center size-full">
        <div className="content-stretch flex gap-[4px] items-center px-[16px] py-[8px] relative size-full">
          <div className="relative shrink-0 size-[8px]">
            <svg className="block size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 8 8">
              <circle cx="4" cy="4" fill="var(--fill-0, #EE0303)" id="Ellipse 731" r="4" />
            </svg>
          </div>
          <div className="flex flex-col font-['Roboto:Regular',sans-serif] font-normal justify-center leading-[0] relative shrink-0 text-[#263238] text-[13px] whitespace-nowrap" style={{ fontVariationSettings: "'wdth' 100" }}>
            <p className="leading-[16px]">Run Invocation Failed</p>
          </div>
        </div>
      </div>
    </div>
...
function Frame61() {
  return (
    <div className="content-stretch flex flex-col h-[246px] items-start overflow-clip relative shrink-0 w-[166px]">
      <Frame40 />
      <Frame43 />
      <Frame44 />
      <Frame45 />
...
function Frame49() {
  return (
    <div className="bg-[#f0f5fd] h-[44px] relative shrink-0 w-full">
      ...
      <div className="flex flex-row items-center size-full">
        <div className="content-stretch flex items-center px-[16px] py-[8px] relative size-full">
          <div className="flex flex-col font-['Roboto:Regular',sans-serif] font-normal justify-center leading-[0] overflow-hidden relative shrink-0 text-[#263238] text-[14px] text-ellipsis w-[247px] whitespace-nowrap" style={{ fontVariationSettings: "'wdth' 100" }}>
            <p className="leading-[normal] overflow-hidden">Lorem ipsum dolor sit amet, consectetur adipiscing elit</p>
          </div>
        </div>
      </div>
    </div>
...
function Frame67() {
  return (
    <div className="content-stretch flex flex-col h-[246px] items-start overflow-clip relative shrink-0 w-[279px]">
      <Frame46 />
      <Frame49 />
      <Frame50 />
      <Frame51 />
...
function Frame66() {
  return (
    <div className="content-stretch flex h-[276px] items-start overflow-x-auto overflow-y-clip relative shrink-0 w-[1343px]">
      <Frame60 />
      <Frame59 />
      <Frame18 />
      <Frame68 />
...
function Frame52() {
  return (
    <div className="bg-[#f8fbff] h-[70px] relative shrink-0 w-full">
      <div aria-hidden="true" className="absolute border border-[rgba(234,237,242,0.3)] border-solid inset-0 pointer-events-none" />
      <div className="flex flex-col items-end justify-center size-full">
        <div className="content-stretch flex flex-col items-end justify-center p-[16px] size-full" />
      </div>
    </div>
  );
}
...
function Edit() {
  return (
    <div className="relative shrink-0 size-[16px]" data-name="Edit">
      <svg className="block size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 16 16">
        <g clipPath="url(#clip0_178_9651)" id="Edit">
          <path d={svgPaths.pee5fb80} id="Icon" stroke="var(--stroke-0, #7E9BC4)" strokeLinecap="round" strokeLinejoin="round" strokeWidth="1.75" />
        </g>
        <defs>
          <clipPath id="clip0_178_9651">
...
function Component() {
  return (
    <div className="content-stretch flex h-[202px] items-start relative shrink-0 w-[1435px]" data-name="Component 5">
