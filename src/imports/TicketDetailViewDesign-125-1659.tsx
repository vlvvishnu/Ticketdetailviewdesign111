import svgPaths from "./svg-8ki3dsamie";
...
function Text1() {
  return <div className="absolute bg-white left-[12px] opacity-74 rounded-[33554400px] size-[6px] top-[11px]" data-name="Text" />;
}
  ...
  return (
    <div className="flex-[1_0_0] h-[20px] min-h-px min-w-px relative" data-name="Text">
      <div className="bg-clip-padding border-0 border-[transparent] border-solid overflow-clip relative rounded-[inherit] size-full">
        <p className="absolute font-['Arimo:Regular',sans-serif] font-normal leading-[20px] left-0 text-[#364153] text-[14px] top-[-2px] w-[124px] whitespace-pre-wrap">S871 | Failure Notes</p>
      </div>
    </div>
  );
}
...
function Text8() {
  return (
    <div className="flex-[1_0_0] h-[20px] min-h-px min-w-px relative" data-name="Text">
      <div className="bg-clip-padding border-0 border-[transparent] border-solid overflow-clip relative rounded-[inherit] size-full">
        <p className="absolute font-['Arimo:Regular',sans-serif] font-normal leading-[20px] left-0 text-[#1c398e] text-[14px] top-[-2px] w-[196px] whitespace-pre-wrap">S877 | Credential Management</p>
      </div>
    </div>
  );
}
...
function Text10() {
  return (
    <div className="flex-[1_0_0] h-[20px] min-h-px min-w-px relative" data-name="Text">
      <div className="bg-clip-padding border-0 border-[transparent] border-solid overflow-clip relative rounded-[inherit] size-full">
        <p className="absolute font-['Arimo:Regular',sans-serif] font-normal leading-[20px] left-0 text-[#364153] text-[14px] top-[-2px] w-[168px] whitespace-pre-wrap">S873 | Terminate workflow</p>
      </div>
    </div>
  );
}
...
function Heading2() {
  return (
    <div className="h-[28px] relative shrink-0 w-full" data-name="Heading 2">
      <p className="absolute font-['Arimo:Bold',sans-serif] font-bold leading-[28px] left-0 text-[#333] text-[18px] top-[-1px]">S877 | Credential Management</p>
    </div>
  );
}
...
function Paragraph5() {
  return (
    <div className="content-stretch flex h-[20px] items-start relative shrink-0 w-full" data-name="Paragraph">
      <p className="flex-[1_0_0] font-['Arimo:Regular',sans-serif] font-normal leading-[20px] min-h-px min-w-px relative text-[#4a5565] text-[14px] whitespace-pre-wrap">Request and manage credentials for troubleshooting</p>
    </div>
  );
}
...
function Paragraph6() {
  return (
    <div className="h-[48px] relative shrink-0 w-[431px]" data-name="Paragraph">
      <div className="bg-clip-padding border-0 border-[transparent] border-solid relative size-full">
        <p className="-translate-x-1/2 absolute font-['Arimo:Regular',sans-serif] font-normal leading-[24px] left-[215.94px] text-[#538ddc] text-[16px] text-center top-[-2px] w-[339px] whitespace-pre-wrap">
          Click here to add details to the ticket to manage
          <br aria-hidden="true" />
          {` credentials`}
        </p>
      </div>
