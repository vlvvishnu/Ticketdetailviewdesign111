import svgPaths from "./svg-xlhekk9dyd";

function Group35() {
  return (
    <div className="absolute contents left-[10.66px] top-[30.27px]">
      <p className="absolute css-ew64yg font-['Roboto:Medium',sans-serif] font-medium inset-[3.54%_77.46%_93.78%_2.46%] leading-[22.576px] text-[16px] text-black" style={{ fontVariationSettings: "'wdth' 100" }}>
...
function Frame21() {
  return (
    <div className="absolute bg-[#354eb4] content-stretch flex gap-[8px] items-center justify-center left-[1098px] px-[16px] py-[8px] rounded-[4px] top-[792px] w-[209px]">
      <div aria-hidden="true" className="absolute border border-[#354eb4] border-solid inset-0 pointer-events-none rounded-[4px]" />
      <p className="css-ew64yg font-['Roboto:Medium',sans-serif] font-medium leading-[normal] relative shrink-0 text-[16px] text-white" style={{ fontVariationSettings: "'wdth' 100" }}>
        Add 208 Results to Ticket
      </p>
    </div>
  );
}
...
function Button() {
  return (
    <div className="absolute bg-white content-stretch flex gap-[8px] h-[34px] items-center justify-center left-[967px] px-[43px] py-[16px] rounded-[6px] top-[793px]" data-name="Button">
      <div aria-hidden="true" className="absolute border border-[#d9d9d9] border-solid inset-0 pointer-events-none rounded-[6px]" />
      <p className="css-ew64yg font-['Roboto:Regular',sans-serif] font-normal leading-[22px] relative shrink-0 text-[14px] text-[rgba(0,0,0,0.88)] text-center" style={{ fontVariationSettings: "'wdth' 100" }}>
        Reset
      </p>
    </div>
  );
...
function Group31() {
  return (
    <div className="absolute contents left-[967px] top-[792px]">
      <Frame21 />
      <Button />
    </div>
  );
...
function Input() {
  return (
    <div className="bg-white col-1 content-stretch flex gap-[8px] h-[32px] items-center justify-center ml-0 mt-[32px] px-[12px] py-[10px] relative rounded-[6px] row-1 w-[455px]" data-name="Input">
      <div aria-hidden="true" className="absolute border border-[#d9d9d9] border-solid inset-0 pointer-events-none rounded-[6px]" />
      <p className="css-4hzbpn flex-[1_0_0] font-['Roboto:Regular',sans-serif] font-normal leading-[22px] min-h-px min-w-px relative text-[14px] text-[rgba(0,0,0,0.85)]" style={{ fontVariationSettings: "'wdth' 100" }}>
...
function InputLabel() {
  return (
    <div className="col-1 content-stretch flex font-['Roboto:Regular',sans-serif] font-normal gap-[4px] h-[32px] items-center leading-[22px] ml-[2.43px] mt-0 relative row-1 text-[14px] w-[97.266px]" data-name="Input__Label">
      <p className="css-ew64yg relative shrink-0 text-[rgba(0,0,0,0.88)]" style={{ fontVariationSettings: "'wdth' 100" }}>
        Workflow
      </p>
      <p className="css-ew64yg relative shrink-0 text-[#f5222d]" style={{ fontVariationSettings: "'wdth' 100" }}>
        *
      </p>
      <p className="css-ew64yg relative shrink-0 text-[rgba(0,0,0,0.88)]" style={{ fontVariationSettings: "'wdth' 100" }}>
        :
...
function Input2() {
  return (
    <div className="absolute bg-white content-stretch flex gap-[8px] h-[32px] items-center justify-center left-0 px-[12px] py-[10px] rounded-[6px] top-[32px] w-[554px]" data-name="Input">
      <div aria-hidden="true" className="absolute border border-[#d9d9d9] border-solid inset-0 pointer-events-none rounded-[6px]" />
      <p className="css-4hzbpn flex-[1_0_0] font-['Roboto:Regular',sans-serif] font-normal leading-[22px] min-h-px min-w-px relative text-[14px] text-[rgba(0,0,0,0)]" style={{ fontVariationSettings: "'wdth' 100" }}>{`Select    `}</p>
      <IconRight2 />
    </div>
  );
}
...
function InputLabel2() {
  return (
    <div className="absolute content-stretch flex font-['Roboto:Regular',sans-serif] font-normal gap-[4px] h-[32px] items-center leading-[22px] left-[2.95px] text-[14px] text-[rgba(0,0,0,0.88)] top-0 w-[118.43px]" data-name="Input__Label">
      <p className="css-ew64yg relative shrink-0" style={{ fontVariationSettings: "'wdth' 100" }}>
        Tenant
      </p>
      <p className="css-ew64yg relative shrink-0" style={{ fontVariationSettings: "'wdth' 100" }}>
        :
...
function Tag() {
  return (
    <div className="bg-[rgba(0,0,0,0.02)] content-stretch flex gap-[4px] items-center justify-center px-[8px] py-0 relative rounded-[4px] shrink-0" data-name="Tag">
      <div aria-hidden="true" className="absolute border border-[#d9d9d9] border-solid inset-0 pointer-events-none rounded-[4px]" />
      <p className="css-ew64yg font-['Roboto:Regular',sans-serif] font-normal leading-[20px] relative shrink-0 text-[11px] text-[rgba(0,0,0,0.88)]" style={{ fontVariationSettings: "'wdth' 100" }}>
        Brightstar Care
      </p>
      <Close />
    </div>
...
function Frame30() {
  return (
    <div className="h-[64px] relative shrink-0 w-[554px]">
      <Group33 />
      <Frame31 />
    </div>
  );
...
function Frame22() {
  return (
    <div className="absolute bg-[#354eb4] content-stretch flex gap-[8px] items-center justify-center left-[1135px] px-[16px] py-[8px] rounded-[4px] top-[9px] w-[143px]">
      <div aria-hidden="true" className="absolute border border-[#354eb4] border-solid inset-0 pointer-events-none rounded-[4px]" />
      <p className="css-ew64yg font-['Roboto:Medium',sans-serif] font-medium leading-[normal] relative shrink-0 text-[16px] text-white" style={{ fontVariationSettings: "'wdth' 100" }}>
        Search
      </p>
...
function Button1() {
  return (
    <div className="absolute bg-white content-stretch flex gap-[8px] h-[34px] items-center justify-center left-[1004px] px-[43px] py-[16px] rounded-[6px] top-[10px]" data-name="Button">
      <div aria-hidden="true" className="absolute border border-[#d9d9d9] border-solid inset-0 pointer-events-none rounded-[6px]" />
      <p className="css-ew64yg font-['Roboto:Regular',sans-serif] font-normal leading-[22px] relative shrink-0 text-[14px] text-[rgba(0,0,0,0.88)] text-center" style={{ fontVariationSettings: "'wdth' 100" }}>
        Reset
      </p>
...
function Group34() {
  return (
    <div className="absolute contents left-[1004px] top-[9px]">
      <Frame22 />
      <Button1 />
    </div>
  );
...
function Frame29() {
  return (
    <div className="content-stretch flex flex-col gap-[12px] h-[137px] items-start relative shrink-0 w-[1278px]">
      <Frame23 />
      <Frame28 />
    </div>
  );
...
function Frame26() {
  return (
    <div className="content-stretch flex flex-col h-[137px] items-start relative shrink-0 w-full">
      <Frame29 />
      <div className="h-0 relative shrink-0 w-full">
        <div className="absolute inset-[-1px_0_0_0]">
          <svg className="block size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 1313.73 1">
            <line id="Line 8" stroke="var(--stroke-0, #EDEDED)" x2="1313.73" y1="0.5" y2="0.5" />
          </svg>
        </div>
      </div>
    </div>
...
function SearchResult() {
  return (
    <div className="absolute h-[26px] left-0 top-0 w-[108px]" data-name="Search result">
      <p className="absolute css-ew64yg font-['Roboto:Bold',sans-serif] font-bold inset-[0_-39.81%_0_0] leading-[25.6px] text-[18px] text-black" style={{ fontVariationSettings: "'wdth' 100" }}>
        208 Results Found
      </p>
    </div>
  );
...
function Radio() {
  return (
    <div className="absolute content-stretch flex gap-[8px] items-start left-[12px] top-[8px]" data-name="Radio">
      <RadioWrapper />
      <p className="css-ew64yg font-['Roboto:Regular',sans-serif] font-normal leading-[0] relative shrink-0 text-[14px] text-[rgba(0,0,0,0.88)]" style={{ fontVariationSettings: "'wdth' 100" }}>
        <span className="leading-[22px]">{`Select All `}</span>
        <span className="font-['Roboto:Bold_Italic',sans-serif] font-bold italic leading-[22px]" style={{ fontVariationSettings: "'wdth' 100" }}>
          208 Result(s)
        </span>
        <span className="leading-[22px]">{` to Add it to Ticket.`}</span>
      </p>
    </div>
  );
}
...
function Frame33() {
  return (
    <div className="absolute bg-[#e8edfe] h-[37px] left-px rounded-[4px] top-[38px] w-[305px]">
      <Radio />
    </div>
  );
}
...
function Frame34() {
  return (
    <div className="absolute bg-[#f4f4f4] h-[37px] left-[321px] rounded-[4px] top-[38px] w-[305px]">
      <Radio2 />
    </div>
  );
}
...
function Frame35() {
  return (
    <div className="h-[75px] relative shrink-0 w-[626px]">
      <SearchResult />
      <Frame33 />
      <Frame34 />
    </div>
...
function TableHeaderDefault() {
  return (
    <div className="bg-[#f3f9fc] content-stretch flex gap-[4.001px] h-[70.017px] items-center pb-[13.003px] pt-[12.003px] px-[12.003px] relative shrink-0 w-[49.012px]" data-name="table-header/default">
      <div aria-hidden="true" className="absolute border-[rgba(0,0,0,0.06)] border-b border-solid inset-0 pointer-events-none" />
      <p className="css-4hzbpn flex-[1_0_0] font-['Roboto:Medium',sans-serif] font-medium leading-[16.004px] min-h-px min-w-px relative text-[12.003px] text-[rgba(0,0,0,0.85)]" style={{ fontVariationSettings: "'wdth' 100" }}>
        &nbsp;
      </p>
    </div>
  );
  ...
  return (
    <div className="relative shrink-0 size-[16px]" data-name="wrapper">
      <svg className="block size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 16 16">
        <g id="wrapper">
          <g id="border" />
          <rect fill="var(--fill-0, #1890FF)" height="16" id="bg" rx="4" width="16" />
          <path d={svgPaths.p19d31200} fill="var(--fill-0, white)" id="check" />
        </g>
      </svg>
    </div>
  );
...
function CheckboxInput() {
  return (
    <div className="h-[22px] opacity-40 relative rounded-[2px] shrink-0 w-[16px]" data-name="Checkbox-Input">
...
function CheckboxInput1() {
  return (
    <div className="h-[22px] opacity-40 relative rounded-[4px] shrink-0 w-[16px]" data-name="Checkbox-Input">
      <div className="bg-clip-padding border-0 border-[transparent] border-solid content-stretch flex items-center justify-center relative size-full">
        <Wrapper1 />
      </div>
    </div>
...
function CheckboxInput5() {
  return (
    <div className="relative rounded-[4px] shrink-0 w-[16px]" data-name="Checkbox-Input">
...
function ComponentsTableColumnText() {
  return (
    <div className="content-stretch flex flex-col items-start relative shrink-0 w-[49.012px]" data-name="Components/Table-Column/Text">
      <TableHeaderDefault />
      <TableCellText />
      <TableCellText1 />
      <TableCellText2 />
...
function Group12() {
  return (
    <div className="absolute inset-[16.65%_24.41%_14.6%_25.59%]">
...
function Group6() {
  return (
    <div className="absolute contents inset-[16.65%_24.41%_14.6%_25.59%]">
      <Group12 />
    </div>
  );
}
...
function Filter() {
  return (
    <div className="relative shrink-0 size-[16px]" data-name="Filter">
      <div className="absolute bg-[#c9cdd5] inset-[0_-0.59%_0_0.59%] rounded-[26px]" />
      <Group19 />
    </div>
  );
}
...
function Frame1() {
  return (
    <div className="content-stretch flex gap-[3px] items-start relative shrink-0">
      <Filter />
      <div className="css-g0mm18 flex flex-col font-['Roboto:Medium',sans-serif] font-medium justify-center leading-[0] relative shrink-0 text-[0px] text-[rgba(0,0,0,0.85)]" style={{ fontVariationSettings: "'wdth' 100" }}>
        <p className="css-ew64yg font-['Roboto:Bold',sans-serif] font-bold leading-[16px] text-[12px]" style={{ fontVariationSettings: "'wdth' 100" }}>
          Tenant
        </p>
      </div>
    </div>
    ...
    <div className="h-[48px] relative shrink-0 w-full" data-name="Components/Table-Cell/Text+Icon">
      <div className="flex flex-row items-center overflow-clip rounded-[inherit] size-full">
        <div className="content-stretch flex gap-[8px] items-center pb-[18px] pt-[17px] px-[12px] relative size-full">
          <p className="css-ew64yg font-['Roboto:Regular',sans-serif] font-normal leading-[22px] relative shrink-0 text-[14px] text-[rgba(0,0,0,0.85)]" style={{ fontVariationSettings: "'wdth' 100" }}>
            Brightstar Care
          </p>
        </div>
      </div>
...
function ComponentsTableCellTextIcon7() {
  return (
    <div className="h-[48px] relative shrink-0 w-full" data-name="Components/Table-Cell/Text+Icon">
      <div className="flex flex-row items-center overflow-clip rounded-[inherit] size-full">
        <div className="content-stretch flex gap-[8px] items-center pb-[18px] pt-[17px] px-[12px] relative size-full">
...
function ComponentsTableColumnText1() {
  return (
    <div className="content-stretch flex flex-col items-start relative shrink-0 w-[227px]" data-name="Components/Table-Column/Text">
      <Frame2 />
    ...
    <div className="h-[48px] relative shrink-0 w-full" data-name="Components/Table-Cell/Text">
      <div className="flex flex-col justify-center overflow-clip rounded-[inherit] size-full">
        <div className="content-stretch flex flex-col items-start justify-center pb-[18px] pt-[17px] px-[12px] relative size-full">
          <p className="css-ew64yg font-['Roboto:Regular',sans-serif] font-normal leading-[22px] relative shrink-0 text-[#263238] text-[14px]" style={{ fontVariationSettings: "'wdth' 100" }}>
            Review Choice Demonstration
          </p>
        </div>
      </div>
...
function ComponentsTableColumnText2() {
  return (
    <div className="content-stretch flex flex-col items-start relative shrink-0 w-[249px]" data-name="Components/Table-Column/Text">
      <Frame3 />
...
function ComponentsTableColumnText3() {
  return (
    <div className="content-stretch flex flex-col items-start relative shrink-0 w-[172px]" data-name="Components/Table-Column/Text">
      <Frame6 />
...
function ComponentsTableColumnText4() {
  return (
    <div className="content-stretch flex flex-col items-start relative shrink-0 w-[133px]" data-name="Components/Table-Column/Text">
      <Frame9 />
...
function ComponentsTableColumnText5() {
  return (
    <div className="content-stretch flex flex-col items-start relative shrink-0 w-[165px]" data-name="Components/Table-Column/Text">
      <Frame12 />
...
function ComponentsTableCellText37() {
  return (
    <div className="h-[48px] relative shrink-0 w-full" data-name="Components/Table-Cell/Text">
      <div className="flex flex-col justify-center overflow-clip rounded-[inherit] size-full">
        <div className="content-stretch flex flex-col items-start justify-center pb-[18px] pt-[17px] px-[12px] relative size-full">
...
function ComponentsTableCellText38() {
  return (
    <div className="h-[48px] relative shrink-0 w-full" data-name="Components/Table-Cell/Text">
      <div className="flex flex-col justify-center overflow-clip rounded-[inherit] size-full">
        <div className="content-stretch flex flex-col items-start justify-center pb-[18px] pt-[17px] px-[12px] relative size-full">
...
function ComponentsTableCellText39() {
  return (
    <div className="h-[48px] relative shrink-0 w-full" data-name="Components/Table-Cell/Text">
      <div className="flex flex-col justify-center overflow-clip rounded-[inherit] size-full">
        <div className="content-stretch flex flex-col items-start justify-center pb-[18px] pt-[17px] px-[12px] relative size-full">
...
function ComponentsTableColumnText6() {
  return (
    <div className="content-stretch flex flex-col items-start relative shrink-0 w-[171px]" data-name="Components/Table-Column/Text">
      <Frame15 />
      ...
      <ComponentsTableCellText37 />
      <ComponentsTableCellText38 />
      <ComponentsTableCellText39 />
    </div>
  );
}
...
function Frame20() {
  return (
    <div className="bg-white h-[22px] opacity-20 relative rounded-[4px] shrink-0 w-full">
      <div aria-hidden="true" className="absolute border border-[#cad2d8] border-solid inset-0 pointer-events-none rounded-[4px]" />
      <div className="flex flex-row items-center size-full">
        <div className="content-stretch flex items-center p-[8px] relative size-full">
          <div className="relative shrink-0 size-[10px]" data-name="Vector">
...
function ComponentsTableCellText40() {
  return (
    <div className="h-[48px] relative shrink-0 w-full" data-name="Components/Table-Cell/Text">
      <div className="flex flex-col justify-center overflow-clip rounded-[inherit] size-full">
        <div className="content-stretch flex flex-col items-start justify-center pb-[18px] pt-[17px] px-[12px] relative size-full">
          <p className="css-ew64yg font-['Roboto:Regular',sans-serif] font-normal leading-[22px] relative shrink-0 text-[#1677ff] text-[14px]" style={{ fontVariationSettings: "'wdth' 100" }}>
            View Input
          </p>
        </div>
      </div>
...
function ComponentsTableCellText41() {
  return (
    <div className="h-[48px] relative shrink-0 w-full" data-name="Components/Table-Cell/Text">
      <div className="flex flex-col justify-center overflow-clip rounded-[inherit] size-full">
        <div className="content-stretch flex flex-col items-start justify-center pb-[18px] pt-[17px] px-[12px] relative size-full">
...
function ComponentsTableCellText42() {
  return (
    <div className="h-[48px] relative shrink-0 w-full" data-name="Components/Table-Cell/Text">
      <div className="flex flex-col justify-center overflow-clip rounded-[inherit] size-full">
        <div className="content-stretch flex flex-col items-start justify-center pb-[18px] pt-[17px] px-[12px] relative size-full">
...
function ComponentsTableCellText43() {
  return (
    <div className="h-[48px] relative shrink-0 w-full" data-name="Components/Table-Cell/Text">
      <div className="flex flex-col justify-center overflow-clip rounded-[inherit] size-full">
        <div className="content-stretch flex flex-col items-start justify-center pb-[18px] pt-[17px] px-[12px] relative size-full">
...
function ComponentsTableCellText44() {
  return (
    <div className="h-[48px] relative shrink-0 w-full" data-name="Components/Table-Cell/Text">
      <div className="flex flex-col justify-center overflow-clip rounded-[inherit] size-full">
        <div className="content-stretch flex flex-col items-start justify-center pb-[18px] pt-[17px] px-[12px] relative size-full">
...
function ComponentsTableCellText45() {
  return (
    <div className="h-[48px] relative shrink-0 w-full" data-name="Components/Table-Cell/Text">
      <div className="flex flex-col justify-center overflow-clip rounded-[inherit] size-full">
        <div className="content-stretch flex flex-col items-start justify-center pb-[18px] pt-[17px] px-[12px] relative size-full">
          <p className="css-ew64yg font-['Roboto:Bold',sans-serif] font-bold leading-[22px] relative shrink-0 text-[#1677ff] text-[14px]" style={{ fontVariationSettings: "'wdth' 100" }}>
            View Input
          </p>
        </div>
      </div>
...
function ComponentsTableCellText46() {
  return (
    <div className="h-[48px] relative shrink-0 w-full" data-name="Components/Table-Cell/Text">
      <div className="flex flex-col justify-center overflow-clip rounded-[inherit] size-full">
        <div className="content-stretch flex flex-col items-start justify-center pb-[18px] pt-[17px] px-[12px] relative size-full">
...
function ComponentsTableCellText47() {
  return (
    <div className="h-[48px] relative shrink-0 w-full" data-name="Components/Table-Cell/Text">
      <div className="flex flex-col justify-center overflow-clip rounded-[inherit] size-full">
        <div className="content-stretch flex flex-col items-start justify-center pb-[18px] pt-[17px] px-[12px] relative size-full">
...
function ComponentsTableColumnText7() {
  return (
    <div className="content-stretch flex flex-col items-start relative shrink-0 w-[112px]" data-name="Components/Table-Column/Text">
      <Frame18 />
      <ComponentsTableCellText40 />
      <ComponentsTableCellText41 />
      <ComponentsTableCellText42 />
      <ComponentsTableCellText43 />
      <ComponentsTableCellText44 />
      <ComponentsTableCellText45 />
      <ComponentsTableCellText46 />
      <ComponentsTableCellText47 />
    </div>
  );
}
...
function Frame24() {
  return (
    <div className="absolute h-[454px] left-[0.73px] rounded-[5.001px] top-[20px] w-[1276px]">
...
function Frame37() {
  return (
    <div className="h-[306px] overflow-clip relative shrink-0 w-[1278px]">
      <Frame24 />
    </div>
  );
}
...
function InputTextArea() {
  return (
    <div className="absolute bg-white content-stretch flex gap-[8.209px] h-[69px] items-start left-[-0.13px] px-[12.314px] py-[5.131px] rounded-[6.181px] top-[45.76px] w-[1274px]" data-name="Input__Text Area">
      ...
      <p className="css-4hzbpn flex-[1_0_0] font-['Roboto:Regular',sans-serif] font-normal leading-[22.576px] min-h-px min-w-px relative text-[#989898] text-[14.367px]" style={{ fontVariationSettings: "'wdth' 100" }}>{`e.g HCHB Outage, scheduled maintenance, etc  `}</p>
...
function InputLabel3() {
  return (
    <div className="absolute content-stretch flex gap-[4.105px] h-[32.966px] items-center left-[0.53px] text-[rgba(0,0,0,0.88)] top-[5.72px] w-[56.629px]" data-name="Input__Label">
      <p className="css-ew64yg font-['Roboto:Medium',sans-serif] font-medium leading-[22.576px] relative shrink-0 text-[14.367px]" style={{ fontVariationSettings: "'wdth' 100" }}>
        Reason/ Message (Optional)
      </p>
      <p className="css-ew64yg font-['Roboto:Regular',sans-serif] font-normal leading-[22px] relative shrink-0 text-[14px]" style={{ fontVariationSettings: "'wdth' 100" }}>
        :
      </p>
    </div>
  );
...
function Frame25() {
  return (
    <div className="h-[182px] relative shrink-0 w-[1299px]">
      <InputTextArea />
      <InputLabel3 />
    </div>
  );
...
function Frame36() {
  return (
    <div className="absolute content-stretch flex flex-col gap-[10px] items-start left-[34.27px] top-[90px] w-[1313.727px]">
      <Frame26 />
      <Frame35 />
      <Frame37 />
      <Frame25 />
...
function TagColorful() {
  return (
    <div className="absolute bg-[#fff0f6] content-stretch flex items-center justify-center left-[1163px] opacity-0 px-[8px] py-px rounded-[15px] top-[300px]" data-name="Tag__Colorful">
      <div aria-hidden="true" className="absolute border border-[#ffadd2] border-solid inset-0 pointer-events-none rounded-[15px]" />
      <p className="css-ew64yg font-['Roboto:Regular',sans-serif] font-normal leading-[20px] relative shrink-0 text-[#eb2f96] text-[14px]" style={{ fontVariationSettings: "'wdth' 100" }}>
        2 out of 208 Selected
      </p>
    </div>
  );
}
...
function Group36() {
  return (
    <div className="absolute contents left-[1163px] top-[300px]">
      <TagColorful />
    </div>
  );
}
