import svgPaths from "./svg-7gi47tm83p";
...
function TableHeaderDefault() {
  return (
    <div className="bg-[#f3f9fc] h-[70.033px] relative shrink-0 w-full" data-name="table-header/default">
...
function TableCellText() {
  return (
    <div className="h-[48.023px] relative shrink-0 w-full" data-name="table-cell/text">
      <div aria-hidden="true" className="absolute border-[rgba(0,0,0,0.06)] border-b border-solid inset-0 pointer-events-none" />
      <div className="flex flex-col items-center justify-center size-full">
...
export default function NewTable() {
  return (
    <div className="relative rounded-[5.001px] size-full" data-name="new table">
