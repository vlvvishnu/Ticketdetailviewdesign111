import svgPaths from "./svg-9vzqdgk1b6";
...
function Text1() {
  return <div className="absolute bg-white left-[12px] opacity-80 rounded-[33554400px] size-[6px] top-[11px]" data-name="Text" />;
}
...
function Icon7() {
  return (
    <div className="relative shrink-0 size-[16px]" data-name="Icon">
      <svg className="block size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 16 16">
        <g clipPath="url(#clip0_127_7122)" id="Icon">
          <path d={svgPaths.p39ee6532} id="Vector" stroke="var(--stroke-0, #99A1AF)" strokeLinecap="round" strokeLinejoin="round" strokeWidth="1.33333" />
        </g>
        <defs>
          <clipPath id="clip0_127_7122">
            <rect fill="white" height="16" width="16" />
          </clipPath>
        </defs>
      </svg>
...
function Text10() {
  return (
    <div className="flex-[1_0_0] h-[20px] min-h-px min-w-px relative" data-name="Text">
      <div className="bg-clip-padding border-0 border-[transparent] border-solid overflow-clip relative rounded-[inherit] size-full">
        <p className="absolute font-['Arimo:Regular',sans-serif] font-normal leading-[20px] left-0 text-[#1c398e] text-[14px] top-[-2px] w-[164px] whitespace-pre-wrap">S880 | State Management</p>
      </div>
    </div>
  );
}
...
function Text11() {
  return (
    <div className="h-[16px] relative shrink-0 w-[37.609px]" data-name="Text">
      <div className="bg-clip-padding border-0 border-[transparent] border-solid content-stretch flex items-start relative size-full">
        <p className="font-['Arimo:Regular',sans-serif] font-normal leading-[16px] relative shrink-0 text-[#6a7282] text-[12px]">3h ago</p>
      </div>
    </div>
  );
}
