import svgPaths from "./svg-ndoxg5qypt";

function Frame36() {
  return (
    <div className="bg-[#354eb4] content-stretch flex items-center justify-center px-[20px] py-[8px] relative rounded-[4px] shrink-0">
...
function Frame42() {
  return (
    <div className="col-1 content-stretch flex gap-[16px] items-start ml-[1188px] mt-0 relative row-1">
      <Frame41 />
    </div>
  );
}
...
function Group35() {
  return (
    <div className="grid-cols-[max-content] grid-rows-[max-content] inline-grid items-[start] justify-items-[start] leading-[0] relative shrink-0">
      <p className="col-1 font-['Roboto:Bold',sans-serif] font-bold leading-[normal] ml-0 mt-[7px] relative row-1 text-[#263238] text-[18px]" style={{ fontVariationSettings: "'wdth' 100" }}>
        Workflows
      </p>
      <Frame42 />
    </div>
...
function CloudUpload() {
  return (
    <div className="absolute left-0 size-[16px] top-0" data-name="CloudUpload">
      <svg className="block size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 16 16">
        <g clipPath="url(#clip0_127_6540)" id="CloudUpload">
...
function Component() {
  return (
    <div className="h-[158px] relative shrink-0 w-[1428px]" data-name="Component 3">
