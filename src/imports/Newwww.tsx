import svgPaths from "./svg-vxifx8rhiv";
...
function Group61() {
  return (
    <div className="absolute contents left-[33px] top-[-83px]">
      <div className="absolute flex h-[83px] items-center justify-center left-[40px] top-[-83px] w-0" style={{ "--transform-inner-width": "0", "--transform-inner-height": "0" } as React.CSSProperties}>
...
function Group60() {
  return (
    <div className="absolute contents left-[33px] top-[-89px]">
      <div className="absolute flex h-[83px] items-center justify-center left-[40px] top-[-89px] w-0" style={{ "--transform-inner-width": "0", "--transform-inner-height": "0" } as React.CSSProperties}>
        <div className="flex-none rotate-[270deg]">
          <div className="h-0 relative w-[83px]">
            <div className="absolute inset-[-1px_0_0_0]">
              <svg className="block size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 83 1">
  ...
  return (
    <div className="relative shrink-0">
      <div className="bg-clip-padding border-0 border-[transparent] border-solid content-stretch flex gap-[16px] items-start relative">
        <Frame106 />
        <div className="flex h-[34px] items-center justify-center relative shrink-0 w-0" style={{ "--transform-inner-width": "0", "--transform-inner-height": "0" } as React.CSSProperties}>
